async function shpdec(file, encoding, precision) {
	encoding = (encoding||"utf8").toLowerCase().replace(/[\-\_]/g,"").replace(/shiftjis/,"sjis");
	importScripts(`https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js`); // jszip
...
////=====================================================================================================================
	...
	var pbf = new PBF({name:file.name.replace(/\.zip$/,""), precision:precision});
