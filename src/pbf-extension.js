...
import { nearPoint } from "./extension/nearPoint.js"; // 独立したファイルをインポート
import { contain } from "./extension/contain.js";     // 独立したファイルをインポート
...
setPrototype("contain", function (pt, one) { return contain(this, pt, one); }); // 変更
setPrototype("nearPoint", function (pt, count, dist) { return nearPoint(this, pt, count, dist); }); // 変更
