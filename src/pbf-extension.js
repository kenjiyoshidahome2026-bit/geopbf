/**
 * PBF Extension Module
 * High-performance, zero-dependency spatial operations and format conversions.
 * Completely eliminates Turf.js to achieve zero-copy architecture and minimize GC overhead.
 */
(function(PBF) {
